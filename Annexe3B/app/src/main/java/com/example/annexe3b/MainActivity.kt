...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // pas besoin d'écouteur, on va enregistrer le seekBar directement
    ...
    fun serialiserVolume(contexte: Context) : Volume {
        ...
        // Création d'un objet volume pour enregistrer les paramètres
    ...
    fun deSerializer(contexte: Context) {
        ...
        try {
            ...
            ois.use {
                ...
                // on met volume directement --> volume!!.sonnerie (!!* car certain qu'il n'est pas nul)
